...
import { majentaSNS } from '@/data/SNS';
        ...
        <div className="ml-[80px] flex flex-col justify-end min-h-[555px] flex-1">
          <div className="flex flex-col text-left">
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <p className="text-h2">Position : Base, Sub Vocal</p>
            </div>           
          </div>
           {/* 1. 40px 하단 여백 후 라인 */}
    ...
    return (
      <div className="flex flex-col w-full py-[20px]">
        ...
        <div className="w-full mt-[20px] flex flex-col text-left">
          <span className="text-h3 font-bold mb-[10px]">Majenta</span>
            <div className="flex flex-col gap-[5px]">
              <p className="text-h4">Name : 마젠타 (이아희)</p>
              <p className="text-h4">Birth Day : 1997.06.02</p>
              <p className="text-h4">Position : Base, Sub Vocal</p>
            </div>  
